...
public class CategoriaConseleView {
  private final Scanner leer = new Scanner(System.in);
    ...
    public void mostrarListaClientes(List<Categoria> clientes){
        ...
        for (Categoria categoria : clientes) {
                    System.out.printf("%-10s %-10s %-10s %-10s", 
                            categoria.getCui(), categoria.getNombre(), categoria.getApellido(), categoria.getCorreoElectronico());
