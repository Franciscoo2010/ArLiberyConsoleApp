...
import org.ar.system.Main; // Importación necesaria para cambiar la escena
...
public class EditorialViewController implements Initializable {
    ...
    @FXML
    private Button btnVolverMenu; // Declaración del botón

    @FXML
    private Label lblMensaje;

    @FXML
    TableView tablaEditoriales;
    ...
    public void eventoGuardar(ActionEvent evento) {
        ...
        if (nit == null || nit.trim().isEmpty() || nombre == null || nombre.trim().isEmpty()) {
